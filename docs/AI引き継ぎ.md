...
- 注意：次の20施設のOpenStreetMap照合は一度自動承認審査で拒否されたが、その後、利用者から「つづけて」と明示承認を得た。公開済みの施設名・都道府県・市区町村だけを送信し、点数や非公開データは送信していない。
- その20件からOpenStreetMap一致7件と、公式住所＋国土地理院住所検索7件の計14件を追加。sourceRow 96、97、98、99、100、101、102、103、104、105、106、107、108、110。現在は座標109/174件、未登録65件。
- saunahouseは現在の公式サイト内容と登録地域が食い違うため、ほか5件とともに推測せず保留。次の1手は未登録65施設の次の小分けを調査する。
